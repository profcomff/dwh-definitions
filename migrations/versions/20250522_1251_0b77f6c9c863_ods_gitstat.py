...
Revision ID: 0b77f6c9c863
Revises: 1d108dc04935
Create Date: 2025-05-22 12:51:50.665509
...
def upgrade():
    op.create_table(
        ...
        sa.Column('sender_id', sa.Integer(), nullable=True, comment='Идентификатор отправителя'),
        sa.Column('sender_login', sa.String(), nullable=True, comment='Логин отправителя'),
