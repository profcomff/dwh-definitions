...
Revision ID: 8f9364a878e2
Revises: fa6331fe4c72
Create Date: 2023-09-02 21:54:30.733200
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('type', sa.Enum('INAPP', 'INTERNAL', 'EXTERNAL', name='type', native_enum=False), nullable=False),
        sa.PrimaryKeyConstraint('id'),
        schema='STG_SERVICES',
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column(
            'system', sa.Enum('TELEGRAM', 'GITHUB', 'VK', name='webhooksystems', native_enum=False), nullable=False
        ),
    ...
    op.create_table(
        'room',
        sa.Column('name', sa.String(), nullable=False),
        sa.Column('direction', sa.Enum('NORTH', 'SOUTH', name='direction', native_enum=False), nullable=False),
    ...
    op.create_group(
        "test_dwh_stg_tgbot_read" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_read"
    )
    op.create_group(
        "test_dwh_stg_tgbot_write" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_write"
    )
    op.create_group("test_dwh_stg_tgbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_all")
    ...
    op.create_group(
        "test_dwh_stg_vkbot_read" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_read"
    )
    op.create_group(
        "test_dwh_stg_vkbot_write" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_write"
    )
    op.create_group("test_dwh_stg_vkbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_all")
    op.create_group(
    ...
    op.grant_on_schema(
        "test_dwh_stg_tgbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_all", "STG_TGBOT"
    )
    op.grant_on_schema(
    ...
    op.grant_on_schema(
        "test_dwh_stg_vkbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_all", "STG_VKBOT"
    )
    op.grant_on_schema(
        "test_dwh_stg_print_read" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_print_read",
        "STG_PRINT",
    ...
    op.grant_on_table(
        "test_dwh_stg_tgbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_all",
        ['ALL'],
        '"STG_TGBOT".tg_user',
    )
    op.grant_on_table(
    ...
    op.grant_on_table(
        "test_dwh_stg_vkbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_all",
        ['ALL'],
        '"STG_VKBOT".vk_user',
    )
    op.grant_on_table(
...
def downgrade():
    ...
    op.drop_table('vk_user', schema='STG_VKBOT')
    ...
    op.drop_table('tg_user', schema='STG_TGBOT')
    ...
    op.delete_group("test_dwh_stg_vkbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_all")
    op.delete_group(
        "test_dwh_stg_vkbot_write" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_vkbot_write"
    )
    op.delete_group(
    ...
    op.delete_group("test_dwh_stg_tgbot_all" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_all")
    op.delete_group(
        "test_dwh_stg_tgbot_write" if os.getenv("ENVIRONMENT") != "production" else "prod_dwh_stg_tgbot_write"
    )
    op.delete_group(
