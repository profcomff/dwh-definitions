...
def upgrade():
    ...
    op.add_column('dm_lecturer_comment_act', sa.Column('some_field', sa.Integer(), nullable=False), schema='DM_RATING')
...
def downgrade():
    ...
    op.drop_column('dm_lecturer_comment_act', 'some_field', schema='DM_RATING')
