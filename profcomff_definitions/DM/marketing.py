...
class FrontendActionsServices(Base):
    ...
    service_from_name: Mapped[str] = mapped_column(comment="Назввание сервиса, откуда пользователь перешел")
    service_to_name: Mapped[str] = mapped_column(comment="Назввание сервиса, куда пользователь перешел")
