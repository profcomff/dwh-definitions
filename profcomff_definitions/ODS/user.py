...
class Info(Base):
    ...
    phone_number: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's phone_number from stg userdata")
    ...
    github_name: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's github_name from stg userdata")
    telegram_name: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's telegram_name stg userdata")
    home_phone_number: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's home_phone_number from stg userdata")
    education_level: Mapped[str | None] = mapped_column(String, nullable=True, comment="Bachelor/Master/Specialist from stg userdata")
    ...
    position: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's position in university from stg userdata")
    student_id_number: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's student_id_number from stg userdata")
    department: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's department in university from stg userdata")
    mode_of_study: Mapped[str | None] = mapped_column(String, nullable=True, comment="full-time/correspondence education from stg userdata")
    ...
    work_location: Mapped[str | None] = mapped_column(String, nullable=True, comment="user's work_location from stg userdata")
    is_deleted: Mapped[bool | None] = mapped_column(Boolean, nullable=True, comment="If True, user was deleted in backend. Default=False")
