...
class GitHub(Base):
    ...
    issue_id: Mapped[str | None] = mapped_column(comment="Идентификатор issue")
    user_id: Mapped[str | None] = mapped_column(comment="Идентификатор пользователя открывшего issue")
    ...
    repository_id: Mapped[str | None] = mapped_column(comment="Идентификатор репозитория")
    assignee_id: Mapped[str | None] = mapped_column(comment="Идентификатор назначенного исполнителем issue")
    ...
    organization_id: Mapped[str] = mapped_column(comment="Идентификатор организации")
